...
<html>
<head>
<title>Matrimonial | Register :: Make My Love
</title>
	    ...
	    <div class="form-group col-sm-6">
            ...
            <div class="form-group col-sm-6">
	            ...
	            <div class="col-sm-4 form_box2">
	                   <div class="select-block1">
	                    <select name="caste">
		                    <option value="Roman Cathaolic">Bengali</option>
		                    <option value="Latin Catholic">Bengali</option>
		                    <option value="Penthecost">Brahmin</option>
		                    <option value="Mappila">Catholic</option>
		                    <option value="Thiyya">Maratha</option>  
							<option value="Thiyya">Other</option>  
	                    </select>
	                  </div>
	                 </div>
	                 <div class="col-sm-4 form_box1">
	            ...
	            <div class="col-sm-4 form_box2">
	                   <div class="select-block1">
	                    <select name="state">
							...
							<option value="Taminadu">Taminadu</option>  
							<option value="Other">Other</option>
	                    </select>
	                  </div>
	                 </div>
