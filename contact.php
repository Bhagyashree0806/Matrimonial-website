...
<html>
<head>
<title>Matrimonial | Contact Us</title>
...
<!--        <a href="index.php"><i class="fa fa-home home_1"></i></a>
   ...
   <div class="grid_5">
      <p><h2>Now,Getting in touch is very easy!!</h2>
	 <h4> You can reach out to us from any of the way given below:</h4></p>
      <address class="addr row">
        ...
        <dl class="grid_4">
            <dt>Telephones :</dt>
			    <dd>Ph: <a href="tel:123456789">123456789</a></dd>
				<dd>Ph: <a href="tel:9812345671">123456789</a></dd>
        </dl>
        <dl class="grid_4">
            <dt>E-mail :</dt>
			   <dd>Email: <a href="mailto:contact@someone.com">help@matrimonial.com</a></dd>
        </dl>
      </address>
    </div>
   </div>
